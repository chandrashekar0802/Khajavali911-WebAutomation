...
public class Driver {
	...
	public void setWebDriver(RemoteWebDriver browser) {
		Driver.browser = browser;
	}

	public WebDriverWait getWebDriverWait() {
		return this.browserWait;
	}

	public void setWebDriverWait(WebDriverWait browserWait) {
		...
		try {
			if (browser == null) {
				...
				case Chrome:
					...
					browserWait = new WebDriverWait(Driver.browser, defaultTimeOut);
					// browser.manage().deleteAllCookies();
					Driver.browser.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
					Driver.browser.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
					Driver.browser.manage().window().maximize();
					break;
				case Windows:
					// System.setProperty("webdriver.chrome.driver",
					// "C:\\Walmart\\chromedriver_win32\\chromedriver.exe");
					...
					// Driver.browser = new WindowsDriver<WindowsElement>(new
					// URL("http://127.0.0.1:4727"), dc);
				...
				case Andriod:
					...
					// Driver.browser = new AndroidDriver<AndroidElement>(new
					// URL("http://localhost:4723/wd/hub"), dc);
