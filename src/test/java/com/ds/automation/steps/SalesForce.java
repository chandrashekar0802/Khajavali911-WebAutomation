...
import com.cigniti.automation.utilities.*;
import com.ds.automation.bussinessfunctions.Elsevier_Home_Page;
import com.ds.automation.bussinessfunctions.Elsevier_Home_Page_Validator;
import com.ds.automation.bussinessfunctions.SalesForce_Page;
import com.ds.automation.bussinessfunctions.SalesForce_Page_Validator;
...
public class SalesForce extends Selenide{
	...
	public void Give_user_login_to_Salesforce_with_the_correct_credentials()throws Throwable
	{
		try{
			...
			BaseUtil.scenarioDef.createNode(new GherkinKeyword("Given"), "Cliked on login button").pass("Username and Password entering entered successfully");
	...
	public void click_on_Opportunities_tab() throws Throwable{
		try{
			...
			BaseUtil.scenarioDef.createNode(new GherkinKeyword("When"), "clicking on Opportunities tab").pass("clicked on Opportunities tab successfully");
	...
	public void clickOnQuoteObject() throws Throwable {
	 ...
	 public void click_on_Case_Object() throws Throwable {
		 try{
			 ...
			 BaseUtil.scenarioDef.createNode(new GherkinKeyword("When"), "clicking on Cases Object").pass("clicked on Cases Object successfully");
