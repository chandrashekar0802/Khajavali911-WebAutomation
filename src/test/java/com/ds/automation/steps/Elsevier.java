...
public class Elsevier {
	 ...
	 public void enter_credentials() throws Throwable{
			...
			com.cigniti.automation.utilities.Reporters.successReport("Enter the username into username text box", "Successfully entered the usernmae and pass word");
			//elsevierValidator.enter_credentials("prabhakar.ontela99@gmail.com", "8125959364");
			elsevierValidator.click_login();
			com.cigniti.automation.utilities.Reporters.successReport("Enter the username into username text box", "Successfully clicked on login button");
