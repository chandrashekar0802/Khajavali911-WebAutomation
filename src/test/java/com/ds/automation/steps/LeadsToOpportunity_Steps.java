...
import com.ds.automation.bussinessfunctions.LeadsToOpportunity_Page_Validator;
import com.ds.automation.bussinessfunctions.LeadsToOpportunity_Pages;
...
public class LeadsToOpportunity_Steps extends Selenide {
	...
	public void enter_the_value_for_First_Name_field() throws Throwable {
		try {			
			...
			String alteredName = faker.name().firstName();
	...
	public void enter_the_value_for_Last_Name_field() throws Throwable {
		try {
			...
			String alteredName = faker.name().lastName();
	...
	public void selectRadioButtonForAccountChooseExisting() throws Throwable {
		try {
			...
			//Reporters.failureReport("click radio button","clicked radio button Choose existing for Account successfully");
