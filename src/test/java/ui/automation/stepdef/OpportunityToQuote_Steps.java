...
public class OpportunityToQuote_Steps extends Selenide{
	...
	public void openOneQuoteFromExistingQuotes() throws Throwable {
		...
		{
			BaseUtil.scenarioDef.createNode(new GherkinKeyword("Given"), "Open one Quote from existing Quotes").fail("Failed to Open one Quote from existing Quotes").addScreenCaptureFromPath(extentreportUtil.ExtentReportScreenShot());
