...
public class CaseToKnowledge_Page extends BasePageElementMap{
	...
	public WebElement assignChk() throws Throwable {
		 return Selenide.getElement(By.xpath("//label[@class='slds-checkbox__label uiLabel']//span[@class='slds-checkbox--faux']"),15);
		}
	public WebElement relatedTab() throws Throwable {
		 return Selenide.getElement(By.xpath("//a[@id='relatedListsTab__item'][1]"),15);
		}
	public WebElement newTask() throws Throwable {
		 return Selenide.getElement(By.xpath("//div[contains(text(),'New Task')][1]"),15);
		}
	public WebElement contactNameField() throws Throwable {
		 return Selenide.getElement(By.xpath("(//span[text()='Contact Name'])[1]/../following-sibling::div[1]//input"),15);  	 
	    }
	
	public WebElement accountNameField() throws Throwable {
		 return Selenide.getElement(By.xpath("(//span[text()='Account Name'])[1]/../following-sibling::div[1]//input"),15);  	 
	    }
	
	public WebElement liza() throws Throwable {
		 return Selenide.getElement(By.xpath("(//span[text()='Account Name'])[1]/../following-sibling::div[1]//ul/li[1]/a"),10); 
		 }
	...
	public @FindBy(xpath="//span[text()='Subject']/../following-sibling::div[1]//a") WebElement subject1DrpDwnBtn;	
	public boolean selectsubject1DrpDwnBtn(String str) throws Throwable {
			return Selenide.SelectItemFromNonSelectListDropDown1(str, subject1DrpDwnBtn);  	 
		    }
	...
	public WebElement commentsField() throws Throwable {
		 return Selenide.getElement(By.xpath("//span[text()='Internal Comments']/../following-sibling::textarea[1]"),15);  	 
	    }
	public WebElement comments1Field() throws Throwable {
		 return Selenide.getElement(By.xpath("//span[text()='Comments']/../following-sibling::input[1]"),15);  	 
	    }
	...
	public WebElement userProfileBtn() throws Throwable {
		 return Selenide.getElement(By.xpath("//div[contains(@class,'profileTrigger branding-user-profile bgimg slds-avatar slds-avatar_profile-image-small circular forceEntityIcon')]"),15);
		}
	...
	public WebElement caseNumber() throws Throwable {
		 return Selenide.getElement(By.xpath("//tr[contains(@class,'dataRow even last first')]//a[1]"),10); 		
	    }
	...
	public boolean solutionGrid() throws Throwable {
        return Selenide.isElementDisplayed(By.xpath("//h3[@id='500Q000000DpRop_RelatedSolutionList_title']"),"Solution Grid");      
    }
	...
	public WebElement hyperLinkInSolutionGrid() throws Throwable {
		 return Selenide.getElement(By.xpath("//tr[contains(@class,'dataRow even first')]//a[contains(@class,'actionLink')][contains(text(),'Select')]"),10); 		
	    }
	...
	public @FindBy(xpath="//select[@id='cas7']") WebElement caseStatusDrpDwnBtn;	
	public boolean selectCaseStatusDrpDwn(String caseStatus) throws Throwable {
			return Selenide.SelectItemFromNonSelectListDropDown1(caseStatus, caseStatusDrpDwnBtn);  	 
		    }
	
	public @FindBy(xpath="//select[@id='cas6']']") WebElement caseReasonDrpDwnBtn;	
	public boolean selectCaseReasonDrpDwn(String caseReason) throws Throwable {
			return Selenide.SelectItemFromNonSelectListDropDown1(caseReason, caseReasonDrpDwnBtn);  	 
		    }
